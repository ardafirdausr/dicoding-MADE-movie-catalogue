...
public class FavouriteMoviesWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.ardafirdausr.movie_catalogue.TOAST_ACTION";
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        Intent toastIntent = new Intent(context, FavouriteMoviesWidget.class);
        toastIntent.setAction(FavouriteMoviesWidget.TOAST_ACTION);
